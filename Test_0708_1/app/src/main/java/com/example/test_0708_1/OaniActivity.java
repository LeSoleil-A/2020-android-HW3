...
public class OaniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oani);
        ...
        startColorPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ColorPicker picker = new ColorPicker(OaniActivity.this);
        ...
        durationSelector.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MaterialDialog.Builder(OaniActivity.this)
    ...
    private void onDurationChanged(String input) {
        ...
        if (isValid) {
            ...
            Toast.makeText(OaniActivity.this, R.string.invalid_duration, Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void resetTargetAnimation() {
        ...
        // 因为 ofArgb 构造并返回在颜色值之间设置动画的ValueAnimator，颜色值的变化和 ofInt、ofFloat不同，所以要评估颜色矩阵的取值就要用 ofArgb
        ...
        // 旋转
        ObjectAnimator animator4 = ObjectAnimator.ofFloat(target, "rotation", 360f);
        ...
        animatorSet.playTogether(animator1, scaleX, scaleY, animator3, animator4);
        animatorSet.start();
    }
}
